...
data_folder='/Users/colette/Library/CloudStorage/GoogleDrive-colette.kelly@whoi.edu/My Drive/postdoc_research/code/2nd_QC_tool/goshipxovers/320620180309';  % DO NOT INCLUDE A FILE SEPARATOR ( \ OR /) AT THE END OF THE PATH!
...
% option to define bounds of the box manually
% comment out these lines if you want to use clickable map instead
latbox = [-72.51 -62.51]; % format: [south north] e.g. [-70 -60]
lonbox = [205.01 215.01]; % format: [west east] e.g. [240 290]
...
GStoolbox_2QC(fid,path,ref_path,ref_name,folder,mindepth,latlim,P,surface,Y, latbox, lonbox, false)
